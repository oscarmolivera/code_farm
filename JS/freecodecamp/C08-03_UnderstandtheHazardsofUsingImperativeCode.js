...
causing incorrect behaviour. The final list of open tabs, stored in finalTabs.tabs, should 
be 
[
  ('FB',     'Gitter', 
  'Reddit', 'Twitter', 
...
Window.prototype.tabClose = function (index) {
  ...
  console.log(`TABS AC: ${this.tabs.length}`)
  
  var tabsBeforeIndex = this.tabs.splice(0, index); // get the tabs before the tab
  console.log(`TABS ANTES CORTE: ${tabsBeforeIndex}`)
  //var tabsLength = this.tabs.length
  var tabsAfterIndex = this.tabs.splice(1); // get the tabs after the tab
  console.log(`TABS ANTES CORTE: ${tabsAfterIndex}`)
