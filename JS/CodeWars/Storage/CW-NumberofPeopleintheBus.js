...
item) in a bus stop. Your task is to return number of people who are still in 
...
var number = function(busStops){
  return busStops.map((num) => num[0] - num[1]).reduce(function(sum, item){return sum + item;});
}