...
Blocks are one of the very few exceptions to the "everything is an object" rule
in Ruby. Blocks are not objects, and they can't be saved to variables.
...
proc_sum_array     = proc { |s| s.reduce(:+) }
my_array = [1, 2, 3]
